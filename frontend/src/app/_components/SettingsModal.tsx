                    ...
                    <div className="grid gap-4 max-h-[400px] overflow-y-auto pr-2">
                      {models.map((model) => (
                        ...
                        >
                          ...
                          <p className="text-gray-600">修改时间：{model.modified}</p>
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
          ...
          <div className="mt-6 flex justify-end">
            <button
              onClick={() => {
                const micDevice = selectedDevices.micDevice || '默认';
                const systemDevice = selectedDevices.systemDevice || '默认';
                toast.success("设备已选择", {
        ...
        <div className="bg-white rounded-lg max-w-4xl w-full mx-4 shadow-xl max-h-[90vh] flex flex-col">
          ...
          <div className="flex justify-between items-center p-6 pb-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">
              {messages.modelSelector ? '需要设置语音识别' : '转录模型设置'}
            </h3>
            <button
          ...
          <div className="p-6 pt-4 border-t border-gray-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-700">显示置信度指示器</p>
                <p className="text-xs text-gray-500">显示彩色圆点以指示转录质量</p>
              </div>
            </div>
